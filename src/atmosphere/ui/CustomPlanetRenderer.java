...
public class CustomPlanetRenderer extends PlanetRenderer
{
    ...
    {
        if((Vars.ui.planet instanceof CustomPlanetDialog customPlanetDialog && !customPlanetDialog.shouldRenderGUI) || (planet.parent == null || !planet.visible() || params.uiAlpha <= 0.02f || !planet.drawOrbit)) return;
